...
import { ArtistDetails, TopArtists, AroundYou, Discover, Search, SongDetails, TopCharts, SavedSongs } from './pages';
...
const App = () => {
  ...
  return (
    <div className="relative flex">
      ...
      {activeSong?.title && (
        <div className="absolute h-28 bottom-0 left-0 right-0 flex animate-slideup bg-gradient-to-br  from-black to-[#2f302f] backdrop-blur-lg rounded-t-3xl z-10">
          <MusicPlayer />
        </div>
      )}
    </div>
